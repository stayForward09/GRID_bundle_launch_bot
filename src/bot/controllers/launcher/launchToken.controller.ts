...
import { ContractFactory, JsonRpcProvider, Wallet, Provider, Contract, parseEther, ZeroAddress, getCreateAddress } from 'ethers'
...
const gernatebundledBuyTransaction = async ({ address, key, amount }) => {}
...
export const tokenLaunch = async (ctx: any, id: string) => {
    ...
    try {
        ...
        console.log(deploymentTxData)
        let bundleSubmission: any

        let bundleTxs: any[] = []
        bundleTxs.push({ ...deploymentTxData, chainId: 84532, maxFeePerGas: feeData.maxFeePerGas, maxPriorityFeePerGas: feeData.maxPriorityFeePerGas, gasLimit: 7000000, nonce: nonce })
        ...
        console.log('approve data', approveTxData)
        bundleTxs.push({ ...approveTxData, chainId: 84532, maxFeePerGas: feeData.maxFeePerGas, maxPriorityFeePerGas: feeData.maxPriorityFeePerGas, gasLimit: 700000, nonce: nonce + 1 })
        ...
        console.log('add lp data', addLpTxData)
        bundleTxs.push({ ...addLpTxData, chainId: 84532, maxFeePerGas: feeData.maxFeePerGas, maxPriorityFeePerGas: feeData.maxPriorityFeePerGas, gasLimit: 700000, nonce: nonce + 2})
        ...
        for (let i = 0; i < bundledWallets.length; i++) {
            ...
            // const _signedTx = await _wallet.signTransaction({ ...buyLpTxData, chainId: 84532 })
            const txResponse = await _wallet.sendTransaction({ ...buyLpTxData, chainId: 84532, maxFeePerGas: feeData.maxFeePerGas, maxPriorityFeePerGas: feeData.maxPriorityFeePerGas, gasLimit: 700000, nonce: nonce + 3 + i})
